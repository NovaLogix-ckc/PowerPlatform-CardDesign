...
[Watch the tutorial on YouTube](https://youtu.be/S3AxY1aNIDI)
...
2. Download the `CardDesign_1_0_0_1.zip` file from the latest release
...
2. Select all files and folders **inside** the folder (not the folder itself):
   ...
   - `solution.xml`
   - `CanvasApps/`
3. Compress them into a `.zip` file (e.g. `CardDesign_1_0_0_1.zip`)
...
2. Find **Card Design** in the list
